...
// FIXME: An already deconstructed parameter does not need objectification. No longer an urgent issue since we forbid destructured objects as inputs. See here: getObjectLiteralsOfNode
